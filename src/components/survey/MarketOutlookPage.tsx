      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-3">
            24. With which of the following new {isLifeSurvey ? 'Life' : 'Short-Term'} Insurers have you placed business or plan to place business in the next 12 months? (Select all that apply)
          </label>
          <div className="space-y-2">
            {(isZambia ? [
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <label className="block text-sm font-medium text-gray-700">
              25. For a new market entrant, to win new business from your brokerage, which THREE resources, services, or commitments are most critical to offer? (Please select up to 3)
            </label>
            <span className="text-xs text-blue-600 font-medium">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            26. Which products do you expect to be the biggest source of growth for your business in the coming year,2026?
          </label>
          <textarea
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-3">
            27. Indicate the extent to which your business is currently using or plans to use Artificial Intelligence (AI)
          </label>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <label className="block text-sm font-medium text-gray-700">
              28. How could your insurer partners better communicate with your company to improve service levels?
            </label>
            <span className="text-xs text-blue-600 font-medium">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <label className="block text-sm font-medium text-gray-700">
              29. What types of support from insurers would help you attract new clients? (Select all that apply)
            </label>
            <span className="text-xs text-blue-600 font-medium">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <label className="flex items-start">
            ...
            <span className="ml-3 text-sm text-gray-700">
              <strong>30. Future correspondence:</strong> I wish to opt out of any follow-up correspondence regarding the Long-term Insurance 2025/26 survey, and I acknowledge that this is inclusive of not being sent the executive summary report and being included in the prize draw.
            </span>
          </label>
        </div>
