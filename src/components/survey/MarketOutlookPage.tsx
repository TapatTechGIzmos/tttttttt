        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <label className="flex items-start">
            ...
            <span className="ml-3 text-sm text-gray-700">
              <strong>32. Future correspondence:</strong> I wish to opt out of any follow-up correspondence regarding the Long-term Insurance 2024/26 survey, and I acknowledge that this is inclusive of not being sent the executive summary report and being included in the prize draw.
            </span>
          </label>
        </div>
