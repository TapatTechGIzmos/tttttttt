      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative w-full">
          ...
          <div className="absolute bottom-8 left-1/2 transform translate-x-[10%]">
            <Link to="/broker-survey" className="inline-block bg-blue-600 text-white px-12 py-4 rounded-md hover:bg-blue-700 transition-colors text-lg font-semibold shadow-lg">
              Take Broker Survey
            </Link>
          </div>
        </div>
