      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative w-full">
          ...
          <div className="absolute bottom-8 left-1/2 transform translate-x-[10%]">
            <Link to="/broker-survey" className="inline-block bg-red-600 text-white px-50 py-2 rounded-md hover:bg-red-700 transition-colors text-lg font-semibold shadow-lg">
              Take Broker Survey
            </Link>
          </div>
        </div>
